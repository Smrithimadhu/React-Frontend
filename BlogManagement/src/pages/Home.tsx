    ...
    <>
      ...
      <div className="container-fluid">
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(to top, lightblue, orange, pink)",
          }}
        >
          <img
        ...
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(to top, pink, orange, pink)",
          }}
        >
          ...
          <div className="col-lg-6">
            ...
            <p className="lead">
              TheBlogHub simplifies content creation and publishing. Focus on
              your message while we handle the technicalities. Share your
              insights effortlessly with a global audience. Join us and elevate
              your blogging experience today.
            </p>
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to bottom, lightblue, pink, orange)",
          }}
        >
          <div className="col-lg-6 order-lg-2">
            ...
            <p className="lead">
              At TheBlogHub, we are passionate about empowering creators to
              share their voices with the world. We believe in the power of
              storytelling and strive to foster a community where ideas can
              flourish. Join us on this journey to transform your blogging
              experience and connect with a global audience.{" "}
            </p>
            <div className="d-grid gap-2 d-md-flex justify-content-md-start">
              <Link
                type="button"
