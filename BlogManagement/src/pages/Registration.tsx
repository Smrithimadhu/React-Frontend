...
const Registration = () => {
  ...
  return (
    <>
      ...
      <div
        className="container mt-5 rounded-5"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="row">
          <div className="col-md-12">
            <br></br>
            <h1 className="text-black" style={{ marginLeft: "280px" }}>
              REGISTRATION
            </h1>
            <br></br>
            <br></br>
          ...
          <form
            className="col-md-6 offset-md-3 text-black"
          ...
          >
            ...
            <div className="form-group row">
              <div className="col-sm-10 offset-sm-2 d-flex justify-content-center mt-4 mb-4">
                <button
                  type="submit"
